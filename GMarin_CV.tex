...
%About: About
\section{About}
\RaggedRight{I'm a software engineer with a background in 
networking and programming.
Passionate about Open-source software, cli applications, 
...
\begin{tabular}{rl}
  \textsc{Advanced}&
    ...
    \textsc{c}oreutils, i3, \textsc{e}macs\\
  \textsc{Intermediate}&
     \textsc{m}ake, \textsc{g}db, \textsc{d}ocker, \textsc{z}ero\textsc{mq},
    \textsc{h}elix, \textsc{l}eft\textsc{wm}\\ 
  \textsc{Basic}&
