...
\section{Personal Data}
    ...
    \end{tabular}
    \begin{tabular}{ll}
        \includesvg[width=13pt]{./svg/linkedin.svg}Linkedin:&
            \href{https://linkedin.com/in/gbrlmarn}{linkedin.com/in/gbrlmarn}\\
        \includesvg[width=13pt]{./svg/github.svg}Github:&
            \href{https://github.com/gbrlmarn}{github.com/gbrlmarn}\\
        \includesvg[width=13pt]{./svg/gbrlmarn.svg}Website:&
...
\begin{tabular}{p{3.1cm}|l}
    ...
    \skill{3}{5}Competent&
        ...
        HTML/CSS\\ 
    \skill{2}{5}Beginner&
        RabbitMQ, Valgrind, Flatbuffers, 
        Hugo, Terraform, Django\\ 
\end{tabular}
